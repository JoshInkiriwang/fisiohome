              ...
              IconButton(
                ...
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text('This is a search buttons')));
                },
              ),
            ]),
        body: ListView(
          ...
          children: [
            ...
            InkWell(
              ...
              onTap: () => ScaffoldMessenger.of(context)
                  .showSnackBar(SnackBar(content: Text('Article2 Pressed'))),
            ),
            SizedBox(height: 5),
            InkWell(
              child: Article3(),
              onTap: () => ScaffoldMessenger.of(context)
                  .showSnackBar(SnackBar(content: Text('Article3 Pressed'))),
            ),
            SizedBox(height: 5),
            InkWell(
              child: Article4(),
              onTap: () => ScaffoldMessenger.of(context)
                  .showSnackBar(SnackBar(content: Text('Article4 Pressed'))),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DetailArticle1()),
      ),
      child: Card(
        elevation: 3.0,
        child: Column(
